...
class ViewController: UIViewController, MAMapViewDelegate, AMapLocationManagerDelegate, CLLocationManagerDelegate{
...
//        speedLabel.text = "\(currLocation.speed)"
//        distanceLabel.text = "\(currLocation.distance(from: <#T##CLLocation#>))"
//    }
}
